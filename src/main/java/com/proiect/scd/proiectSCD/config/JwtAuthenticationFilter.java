...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
  ...
  protected void doFilterInternal(
    ...
    String jwt = authHeader.substring(7); //Extrat the token from authorization (authentication) header
    String username = jwtService.extractUsername(jwt); //extract the user email from JWT Token
